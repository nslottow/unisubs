...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute('alter table videos_videourl character set ascii collate ascii_general_ci;')


    def backwards(self, orm):
        db.execute('alter table videos_videourl character set utf8 collate utf8_unicode_ci;')
